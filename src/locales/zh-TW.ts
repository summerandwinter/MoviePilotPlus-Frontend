export default {
  ...
  bilibiliCookieTips: '訪問https://www.bilibili.com/ 1、打開控制臺 2、復制請求頭中完整的Cookie 3、黏貼到上面的輸入框中',
  bilibiliCookieTipsTitle: '獲取方式：',
      tvFileFormatHint: '設置电视剧文件格式，使用Jinja2語法，支持變量：cn_title, en_title, version, year, resolution, source, video_codec, audio_codec, bit_depth, frame_rate, audio_tracks, team, site, season, episode, subtitle_language, audio_language, hdr_format, audio_channe',
      movieFileFormatHint: '設置電影文件格式，使用Jinja2語法，支持變量：cn_title, en_title, version, year, resolution, source, video_codec, audio_codec, bit_depth, frame_rate, audio_tracks, team, site, season, episode, subtitle_language, audio_language, hdr_format, audio_channe',
      tvTitleFormatHint: '設置电视剧標題格式，使用Jinja2語法，支持變量：cn_title, en_title, version, year, resolution, source, video_codec, audio_codec, bit_depth, frame_rate, audio_tracks, team, site, season, episode, subtitle_language, audio_language, hdr_format, audio_channel',
      movieTitleFormatHint: '設置電影標題格式，使用Jinja2語法，支持變量：cn_title, en_title, version, year, resolution, source, video_codec, audio_codec, bit_depth, frame_rate, audio_tracks, team, site, season, episode, subtitle_language, audio_language, hdr_format, audio_channel',
      tvFolderFormatHint: '設置电视剧文件夾格式，使用Jinja2語法，支持變量：cn_title, en_title, version, year, resolution, source, video_codec, audio_codec, bit_depth, frame_rate, audio_tracks, team, site, season, episode, subtitle_language, audio_language, hdr_format, audio_channel',
      movieFolderFormatHint: '設置電影文件夾格式，使用Jinja2語法，支持變量：cn_title, en_title, version, year, resolution, source, video_codec, audio_codec, bit_depth, frame_rate, audio_tracks, team, site, season, episode, subtitle_language, audio_language, hdr_format, audio_channel',
  ...
  siteshema: {
    noSites: '沒有站點',
    sitesWillBeShownHere: '已添加併支持的站點將會在這裏顯示。',
    noFilterData: '沒有符合條件的站點',
    title: '站點',
    status: {
      enabled: '啟用',
    ...
    hints: {
      ...
      template: '配置站點分類、來源、分辨率、視頻編碼、音頻編碼、地區、制作組、標簽等字典與繫統標准字典的映射關繫'
    },
    actions: {
      add: '新增站點模闆',
      edit: '編輯站點模闆',
